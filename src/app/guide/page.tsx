...
const FAQ = [
  {
    q: "VOICE Cash가 뭔가요?",
    a: "플랫폼 안에서만 쓰이는 폐쇄형 포인트입니다(1 Cash = 1원, 외부 이전·거래 불가). 지갑 페이지에서 무통장 입금으로 충전하고, 그 잔액으로 구매합니다. 판매 수익은 정산되면 VOICE Cash로 적립되고, 정산 신청을 하면 관리자가 실제 원화로 지급합니다.",
  },
  {
    q: "무통장 입금은 어떻게 하나요?",
    a: "지갑 페이지에 안내된 계좌로 원하는 금액을 입금한 후, 실제 입금하신 입금자명과 금액을 정확히 입력해 신청해주세요. 관리자가 실제 입금 내역을 확인하면 캐시가 적립됩니다(보통 영업일 기준으로 확인). 입금자명이나 금액이 맞지 않으면 신청이 거절될 수 있으니, 계좌에 찍히는 이름 그대로 입력해주세요.",
  },
  {
    q: "에스크로는 어떻게 동작하나요?",
