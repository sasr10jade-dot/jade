  ...
  return (
    <div className="fixed inset-0 z-40 flex flex-col bg-background">
      ...
      <div className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-8 overflow-hidden px-5 md:flex-row md:items-start">
        ...
        <div className="flex min-h-0 flex-1 flex-col border-t pt-4 md:border-t-0 md:border-l md:pl-8 md:pt-0">
          ...
          <div className="mt-2 min-h-0 flex-1 space-y-1 overflow-y-auto pb-4">
            {orderedQueue.map((t, i) => (
              <button
                ...
                type="button"
                onClick={() => playAt(i)}
                className={`flex w-full items-center gap-3 rounded-lg p-2.5 text-left transition hover:bg-muted ${i === position ? "bg-muted" : ""}`}
              >
